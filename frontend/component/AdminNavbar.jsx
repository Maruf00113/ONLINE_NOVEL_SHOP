...
const AdminNavbar = () => {
  ...
  return (
    <div className="fixed w-full flex justify-between items-center bg-blue-900 text-white px-6 py-4 z-100">
      ...
      <div>
        ...
        <button onClick={() => {
           navigate("/");
        }} type="button" className="bg-red-500 px-4 py-2 rounded-2xl hover:bg-red-700 active:bg-red-600 cursor-pointer">
          Logout
        </button>
